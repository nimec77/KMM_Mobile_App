...
fun GamesAdminScreen() {
  ...
  ViewModel(factory = { GamesAdminViewModel() }) { viewModel ->
    ...
    LazyColumn {
      item {
        Row(modifier = Modifier.padding(16.dp)) {
          ...
          Icon(
            modifier = Modifier.clickable { viewModel.obtainEvent(GamesAdminEvent.CreateGameClicked) },
    ...
    when (viewAction) {
      GamesAdminAction.CreateGame -> rootController.push(NavigationTree.Desktop.CreateGame.name)
      null -> {}
    }
  }
